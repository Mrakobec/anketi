...
public class AnketiTestContainer extends TestContainer {

    public AnketiTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/anketi/app.properties",
    ...
    public static class Common extends AnketiTestContainer {

        public static final AnketiTestContainer.Common INSTANCE = new AnketiTestContainer.Common();
